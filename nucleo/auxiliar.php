<?php
	...
	{   
		...
		public function __QR($option, $width=400)
    	{    	
			$option=urlencode($option);
			return "<img width=\"$width\" src='../../nucleo/qrlib/imagen_qr.php?data=$option'>";
		}
		public function __MAP($option, $zoom=11, $width=400)
    	{    	
			return "
				<a href=\"https://www.google.com/maps/dir//$option/@$option,15z?entry=ttu\">
					<img width=\"$width\" src='https://maps.googleapis.com/maps/api/staticmap?center=$option&zoom=$zoom&size=300x170&key=AIzaSyCTDTeSJ3Uu3hHCy73RzGoJbx6vmKcmmUI&markers=size:mid|color:red|$option'>
				</a>	
			";
		}
